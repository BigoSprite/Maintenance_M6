...
class RealEstateInfo_Controller extends Controller
{
     ...
     *
     * 响应请求 方法 GET
     * 对应路由：http://localhost:8888/api/content/realEstateInfo/jinyehotel
     */
    public function getRealEstateInfo($dbName)
    {
        $realEstateModel = RealEstateInfo_Model::where('dbName', $dbName)->first();
...
//                'dbPassword'=>$realEstateModel->dbPassword
     ...
     *
     * 响应请求 方法 GET
     * 对应路由：http://localhost:8888/api/content/realEstateInfoList
     */
    public function getRealEstateInfoList()
    {
        $realEstateModelArray = RealEstateInfo_Model::all();
        $resultArray = array();
...
//    {
//        $model = RealEstateInfo_Model::where('dbName', $currentRealEstate)->first();
//        $retArray = array();
//        if($model != null){
//            $realEstateTmp = [
...
//    }
    ...
    public function insertRealEstateInfo()
    {
        ...
        $realEstateModel = RealEstateInfo_Model::where('name', $realEstateName)->first();
        if($realEstateModel != null) {
            return response()->json(['status'=>'fail', 'isExist'=>'true'], 200);
        }else{

            $model = new RealEstateInfo_Model;
